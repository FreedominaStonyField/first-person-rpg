...
4. When making node or API assumptions, consult the Godot documentation included with the engine to confirm the node exists and exposes the features we plan to use.
