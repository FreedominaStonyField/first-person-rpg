...
- BehaviorStateMachine routes into CombatStateMachine after combat is engaged; combat machine chooses Attack/Chase/Flee each frame based on distance and health:
  - Flee if flees_at_low_health is true and health/max_health_reference <= flee_health_fraction (25% default).
...
- max_health_reference (baseline used for flee math; default: ActorStats.MAX_STAT)
